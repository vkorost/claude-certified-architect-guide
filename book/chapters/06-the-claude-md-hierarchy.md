...
C. Add the instructions to CLAUDE.local.md at the project root and commit that file. D. Configure the managed policy file to load user-level settings from a shared network location.
